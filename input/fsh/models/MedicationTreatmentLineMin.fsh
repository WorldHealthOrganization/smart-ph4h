...
* s 1..1 string "Subject (Patient Reference)" "Reference to the patient who is the subject of the medication treatment line, expressed as a simple string (e.g. patient identifier)."
