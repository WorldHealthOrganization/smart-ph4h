...
Within the <a href="input/pagecontent/index.md">PH4H trust framework</a>, participating countries agree on a range of [use cases](https://github.com/WorldHealthOrganization/smart-ph4h/blob/main/input/pagecontent/trust_domain_use_cases.md), underpinned by a pre-established governance mechanism subject to ongoing discussion. 
