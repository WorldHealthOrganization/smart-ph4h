...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement">
      ...
      <sch:assert test="count(f:extension[@url = 'http://smart.who.int/ph4h/StructureDefinition/ihe-ext-medicationstatement-verificationinformation']) &lt;= 1">extension with URL = 'http://smart.who.int/ph4h/StructureDefinition/ihe-ext-medicationstatement-verificationinformation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://smart.who.int/ph4h/StructureDefinition/ihe-ext-medicationstatement-substitution']) &lt;= 1">extension with URL = 'http://smart.who.int/ph4h/StructureDefinition/ihe-ext-medicationstatement-substitution': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
